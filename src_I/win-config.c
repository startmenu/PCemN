        ...
        switch (message)
        {
			...
			if (mem < 1 || mem > 256)
			{
				...
				break;
                        ...
                        if (temp_model != model || gfx != gfxcard || mem != mem_size || fpu != hasfpu || temp_GAMEBLASTER != GAMEBLASTER || temp_GUS != GUS || temp_SSI2001 != SSI2001 || temp_sound_card_current != sound_card_current || temp_network_card_current != network_card_current)
                        {
